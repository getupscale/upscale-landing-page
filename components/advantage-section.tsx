  ...
  return (
    <section className="bg-surface-light py-24 dark:bg-surface-dark">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/40 bg-white/40 shadow-2xl backdrop-blur-md dark:border-gray-800 dark:bg-background-dark/40">
          <div className="grid grid-cols-3 border-b border-white/30 bg-white/60 dark:border-gray-800 dark:bg-gray-900/50">
          ...
          {[
            ...
            >
              ...
              <div className="border-l border-r border-secondary/20 bg-secondary/10 p-6 text-sm font-bold text-green-600 backdrop-blur-sm">
                {withValue}
              </div>
            </div>
          ))}
